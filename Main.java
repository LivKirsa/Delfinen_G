...
public class Main{
   ...
   public static void main(String [] args){
        ...
        Member m9 = new Member("Henry Moore", "2008-05-17", false, false, true);
        ...
        Member m13 = new Member("Leo Martinez", "2009-12-05", true, true, false);
        Member m14 = new Member("Mia Martin", "1994-03-30", false, false, true);
        Member m15 = new Member("Nina Jackson", "2010-07-08", true, true, true);
